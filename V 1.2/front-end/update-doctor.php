                    ...
                    if ($stmt = $conn->prepare($sql)) {
                        ...
                        if ($stmt->execute()) {
                            ...
                            if ($result->num_rows == 1) {
                                ...
                                echo '
                                <form action="../back-end/edit/doctor.php" method="post" class="meet__doctor__search__meet">
                                    ...
                                    <div class="meet__doctor__search">
                                        ...
                                        <label for="specialtyapp">Specialty</label>
                                        <input type="text" id="specialtyapp" placeholder="Your Specialty" name="specialty" value="' . $row["Specialty"] . '">
                                    </div>
                                    <div class="meet__doctor__search">
                                        <div class="meet__doctor__search__icon">
                                            <i class="icofont icofont-doctor"></i>
                                        </div>
                                        <label for="qualificationsapp">Qualifications</label>
                                        <input type="text" id="qualificationsapp" placeholder="Your Qualifications" name="qualifications" value="' . $row["Qualifications"] . '">
                                    </div>
                                    <div class="meet__doctor__search">
                                        <div class="meet__doctor__search__icon">
                    ...
                    <div class="footer__list">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>
                                    15 6'october, Hosary Street,<br> cairo egypt
                                </p>
                            </li>
                        </ul>
                    </div>
